...
export default class Controller {
    ...
    import_preset_file() {
        let id = document.querySelector('input[name="NodesImportPresetFile"]:checked').value;
    ...
    import_id_preset_world() {
        let id = document.getElementById(document.querySelector('input[name="NodesImportPresetFile"]:checked').value).value;
    ...
    delete_layer(layer_name, type) {
        ...
        this.view.renderer.map.getLayers().getArray()
